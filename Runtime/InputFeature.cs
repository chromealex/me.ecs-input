...
namespace ME.ECS.Essentials {
    ...
    public struct InputAction<TMarker, TComponent> where TMarker : unmanaged, ME.ECS.Essentials.Input.Input.Markers.IInputPointerMarker where TComponent : unmanaged, IInputPointerComponent {
    ...
    public struct InputGesture<TMarker, TComponent> where TMarker : unmanaged, ME.ECS.Essentials.Input.Input.Markers.IInputGesture2FingersMarker where TComponent : unmanaged, IInputGesture2FingersComponent {
